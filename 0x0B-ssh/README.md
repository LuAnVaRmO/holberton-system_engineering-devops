...
## Background Context
![Image](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-sysadmin_devops/244/zPVRKhPsUP5lK.gif)
...
|----------|---------|-------|-------| ----- | ----- | ---- |
| 1519-web-01 | ubuntu |34.75.43.80	|  running |	`Soft reboot` | `Hard reboot`	 | `Ask a new server` |
