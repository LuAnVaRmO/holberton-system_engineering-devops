...
* Server
	...
	* [Where are servers hosted (data centers)](https://www.youtube.com/watch?v=iuqXFC_qIvA&feature=youtu.be&t=33)
	...
	Do not mix up *server* and *web server*. (Check out the [web server concept page](https://developer.mozilla.org/en-US/docs/Learn/Common_questions/What_is_a_web_server) to know more about this.)
* Web server
* DNS
* Load balancer
* Monitoring
...
Add URLs here:_____________________________
