...
* [Shell](https://github.com/LuAnVaRmO/holberton-system_engineering-devops/blob/master/0x04-loops_conditions_and_parsing/SHEEL.md)
...
![image](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-sysadmin_devops/251/ubHWxDU.png)
...
![imagetask12](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-sysadmin_devops/251/1jsawaI.jpg)
Read:

* [IFS (internal field separator)](https://www.tldp.org/LDP/abs/html/internalvariables.html)
* [Understanding /etc/passwd](https://www.cyberciti.biz/faq/understanding-etcpasswd-file-format/)

The file `/etc/passwd` has already been covered in a [previous project](https://github.com/LuAnVaRmO/holberton-system_engineering-devops/tree/master/0x02-shell_redirections) and you should be familiar with it. Today we will make up a story based on it.
...
![imagetask13](https://intranet.hbtn.io/images/contents/sysadmin/projects/80/such_awk.jpg)
